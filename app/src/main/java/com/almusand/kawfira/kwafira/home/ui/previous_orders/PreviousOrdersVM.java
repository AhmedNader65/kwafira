...
public class PreviousOrdersVM extends BaseViewModel {
    ...
    public void initAppointments(String auth){
        ...
        RetroWeb.getClient().create(ServiceApi.class).onGetOrders("complete","Bearer "+auth).enqueue(new Callback<OrdersResModel>() {
            @Override
